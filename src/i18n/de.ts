export const de = {
  ...
  research: {
    ...
    fragility: {
      heading: '5. Bewertungsfragilität: Core RG vs. Narrative RG',
      subheading: 'Die aggregierte Marktbewertung zeigt nur einen Teil des Bildes. Die Fragilitätsanalyse unterteilt Unternehmen in einen fundamental verankerten Kern und ein narrativgetriebenes Segment und misst, wie weit sie auseinanderdriften. Ein großer und wachsender Spread ist ein strukturelles Signal — er erfasst die Marktspaltung, nicht nur die aggregierte Überbewertung.',
      ...
      methodQuartile: 'unteres Quartil = Core-RG-Gruppe; oberes Quartil = Narrative-RG-Gruppe',
      methodThird: 'unteres Drittel = Core-RG-Gruppe; oberes Drittel = Narrative-RG-Gruppe',
      ...
      frameworkHeading: 'Drei Marktstrukturen',
      frameworkCases: [
        {
          label: 'Fall A — Einheitlich teuer',
          description: 'Core RG und Narrative RG sind beide erhöht, der Spread ist klein und die Ratio nahe 1. Der gesamte Markt ist im Verhältnis zu den Gewinnen gestreckt — dasselbe Signal wie ein hoher Makro-RG. Nicht per se fragiler als ein gespaltener Markt; das Risiko ist breit, nicht konzentriert.',
        },
        {
          label: 'Fall B — Gespaltener Markt',
          description: 'Core RG bleibt moderat, während Narrative RG sehr hoch ist — großer Spread, hohe Ratio. Das fundamental verankerte Segment und das narrativgetriebene Segment preisen völlig unterschiedliche Zukünfte ein. Diese strukturelle Spaltung ist das deutlichste Fragilitätssignal: Die Lücke kann nicht dauerhaft bestehen, ohne dass entweder die Gewinne aufholen oder die Preise korrigieren.',
        },
        {
          label: 'Fall C — Selektive Blase',
      ...
      frameworkNote: 'Fragility Spread und Ratio ergänzen den Makro-RG (CAPE/10), ersetzen ihn jedoch nicht. Makro-RG misst die aggregierte Überhöhung; Fragility misst die strukturelle Spaltung innerhalb der Verteilung.',
      signalHeading: 'Fragilitäts-Momentaufnahme',
      currentCoreRgLabel: 'Core RG (aktuell)',
      currentNarrativeRgLabel: 'Narrative RG (aktuell)',
      peakSpreadLabel: 'Spitze Fragility Spread',
      currentSpreadLabel: 'Aktueller Fragility Spread',
      peakRatioLabel: 'Spitze Fragility Ratio',
      currentRatioLabel: 'Aktuelle Fragility Ratio',
      divergenceChartHeading: 'Core RG vs. Narrative RG im Zeitverlauf',
      divergenceLegendCons: 'Core RG (konservative Gruppe)',
      divergenceLegendHigh: 'Narrative RG (hohe Gruppe)',
      spreadChartHeading: 'Fragility Spread im Zeitverlauf (Narrative RG − Core RG)',
      ratioChartHeading: 'Fragility Ratio im Zeitverlauf (Narrative RG / Core RG)',
      ...
      interpretation: {
        heading: 'Wie die Core-RG-/Narrative-RG-Divergenz zu lesen ist',
        items: [
          {
            title: 'Steigender Spread oder Ratio',
            body: 'Eine wachsende Lücke zwischen Narrative RG und Core RG bedeutet, dass die narrativgetriebenen Bewertungen sich weiter vom fundamental verankerten Kern entfernen. Im vorliegenden Datensatz erreichte der Fragility Spread in GJ 2024 seinen Höchststand — ca. 45 % über dem GJ-2023-Niveau.',
          },
          {
            title: 'Schnelles Divergenzwachstum',
            body: 'Beschleunigtes Spread-Wachstum — wie von GJ 2023 auf GJ 2024 beobachtet — kann auf zunehmende spekulative Konzentration im Narrative-RG-Segment hinweisen. Dies beweist keinen Absturz oder eine Korrektur, erhöht aber die strukturelle Anfälligkeit, wenn die Divergenz nicht durch Gewinnwachstum gedeckt werden kann.',
          },
          {
            title: 'Nachfolgende Kontraktion',
            body: 'Der Fragility Spread ist von seinem GJ-2024-Höchststand deutlich auf das aktuelle Niveau zurückgegangen. Core RG stieg leicht an, Narrative RG fiel signifikant — konsistent mit einer Neubewertung der am stärksten überbewerteten Namen, wobei die kausale Interpretation unklar bleibt.',
          },
          {
