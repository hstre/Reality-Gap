...
Role: ONBOARDING new HK-listed companies (creates the initial JSON and
registers the slug in the China index). Ongoing daily maintenance of all
existing company files — including these — runs through
scripts/refresh_all.py, which is file-driven and merge-based.
...
CHINA_MEMBERS: list[tuple] = [
    ...
    ("9988.HK", "Alibaba",       "Consumer Discretionary",   "alibaba"),
    ...
    ("1211.HK", "BYD",           "Consumer Discretionary",   "byd"),
